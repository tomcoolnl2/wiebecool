export const tokyo = {
	...
	portfolioHover() {
		const tokyo_tm_portfolio_animation_wrap = document.querySelectorAll('.tokyo_tm_portfolio_animation_wrap'),
			tokyo_tm_portfolio_titles = document.querySelector('.tokyo_tm_portfolio_titles') as HTMLElement;
